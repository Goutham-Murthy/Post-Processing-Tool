...
class CHP(annuity.Annuity):
    ...
    Attributes:
        model_name: (string)Model of the CHP.
        ...
        emissions: (float) Emissions of the CHP unit throughout the year [kg of CO2].
        annuity: (float)Annuity of the CHP [Euros].
        bonus: (float)BAFA Bonus provided for the installation of the CHP unit [Euros].
        heat_hourly: (float)Hourly values of the heat demand met by the CHP unit [kWh].
        heat_yearly: (float)Heat provided by the CHP unit over the year[kWh].
        electricity_yearly: (float)Electricity generated by the CHP unit throughout the year [kWh]
        electricity_hourly: (float) Hourly values of electricity generated by the CHP unit [kWh]
    ...
    def set_annuity(self, storage=False):
        ...
        :param storage: (bool)True if storage is present and false if not present
        :return: none
        """
...
class OnOffCHP(CHP):
    def get_heat(self, required_heat, hour, ThSt=None):
        ...
        :param ThSt: (class ThSt)Thermal Storage instance when present.
        :return: required_heat: (float)Hourly thermal demand not met by the CHP unit [kWh].
        """
        if ThSt is not None:
    ...
    def get_electricity(self, required_electricity, hour, ElSt=None):
        ...
        :return: required_electricity: (float)Hourly electrical demand not met by the CHP unit [kWh].
        """
